...
void address_print(const address_t *address)
{
    ...
    switch (address->cna) {
	    ...
	    R0 = (int32_t)address->rfsi.r[0];
	    R1 = (int32_t)address->rfsi.r[1];
	    R2 = (int32_t)address->rfsi.r[2];
	    F0 = (int32_t)address->rfsi.f;
	    S0 = (int32_t)address->rfsi.s[0];
	    S1 = (int32_t)address->rfsi.s[1];
	    I0 = (int32_t)address->rfsi.i[0];
	    I1 = (int32_t)address->rfsi.i[1];
	    I2 = (int32_t)address->rfsi.i[2];
